<h2>2178. Maximum Split of Positive Even Integers</h2><h3>Medium</h3><hr><div><p>You are given an integer <code>finalSum</code>. Split it into a sum of a <strong>maximum</strong> number of <strong>unique</strong> positive even integers.</p>
